                    ...
                    Card(
                      child: Column(
                        children: <Widget>[
                          ListTile(
                            selected:
                                questao?.aplicada != null && !questao.aplicada,
                            // ? true
                            // : false,
                            ...
                            child: Wrap(
                              children: <Widget>[
                                ...
                                IconButton(
                                  ...
                                  onPressed: questao.problema.url != null &&
                                          questao.problema.url.isNotEmpty
                                      ? () {
                                          try {
                                ...
                                if (questao.aplicada != null &&
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      bloc.eventSink(
                                          ResetTempoTentativaQuestaEvent(
                                              questao.id, questao.aplicada));
                                    },
                                  ),
